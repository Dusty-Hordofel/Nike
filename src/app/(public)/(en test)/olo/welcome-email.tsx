...
const WelcomeEmail = () => {
  return (
    <Html lang="en" dir="ltr">
      <Head />
      <Preview>
        You&rsquo;re now ready to make live transactions with Stripe!
      </Preview>
      <Body style={main}>
        <Container style={container}>
          <Section style={box}>
            ...
            <Text style={paragraph}>
              Thanks for submitting your account information. You&rsquo;re now
            ...
            <Hr style={hr} />
            <Text style={paragraph}>
              If you haven&rsquo;t finished your integration, you might find our{" "}
            ...
            <Text style={paragraph}>
              Once you&rsquo;re ready to start accepting payments, you&rsquo;ll
            ...
            <Text style={paragraph}>
              Finally, we&rsquo;ve put together a{" "}
              <Link
                style={anchor}
            ...
            <Text style={paragraph}>
              We&rsquo;ll be here to help you with any step along the way. You
