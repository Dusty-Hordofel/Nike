...
const subProductSchema = z.object({
  ...
  images: z.array(
    z.object({
      public_url: z.string().optional(), // Peut ne pas être disponible avant le téléchargement
      url: z.string().optional(), // Peut ne pas être disponible avant le téléchargement
      file: z.instanceof(File).optional(), // Fichier sélectionné
      preview_url: z.string().optional(), // URL de prévisualisation générée par FileReader
    })
  ),
